...
<!--      MY EIGHT POINT STAR -->
    <link rel="stylesheet" href="css_login/my_eight_point_star.css">
...
<!--     	<hr />-->
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-block btn-large" name="btn-signup">
    		<span class="glyphicon glyphicon-log-in"></span> &nbsp; Create Account
			</button> 
            
            <a href="index.php" class="btn btn-primary btn-block btn-large" >Log In Here</a>
...
<!--
    ...
    <form method="post" class="name">
        ...
        <button type="submit" name="btn-signup" class="btn btn-primary btn-block btn-large">Sign Up</button>
        <a href="my_login_form.php" class="btn btn-primary btn-block btn-large">Log In Here</a></td>
    </form>
</div>-->
<script src="js_login/sign_up_index.js"></script>
